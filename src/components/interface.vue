  ...
  <div>
    <div>
      ...
      <b-sidebar id="sidebar-1" title="Informationen" shadow>
        <div class="px-3 py-2">
          <b-img class="image" src="../assets/foto3.jpeg" fluid thumbnail></b-img>
          <h2>Line Follower</h2>
          <p>
          ...
          <b-img class="image" src="../assets/foto.jpeg" fluid></b-img>
          <br />
          <br />
          <b-img class="image" src="../assets/foto2.jpeg" fluid></b-img>
          <br />
          <br />
          <h5>Entwicklung</h5>
          <p>
          ...
          <br/>
          <b-img class="image" src="../assets/foto4.jpeg" fluid></b-img>
          <br />
        </div>
      </b-sidebar>
    </div>
